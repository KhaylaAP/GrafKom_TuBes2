Pada tugas besar ini kami membuat sebuah game bullet hell di mana player butuh menghindari bullet dari enemy dan mencoba untuk menembak enemy agar enemy nya mati.
...
3D Model Credits
- Player Model:
- "Smol(ler) Gura - Gawr Gura, HoloMyth" (https://skfb.ly/o799I) by Seafoam is licensed under Creative Commons Attribution-NonCommercial (http://creativecommons.org/licenses/by-nc/4.0/).
